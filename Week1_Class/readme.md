...
These are exercises conducted in-class. 
For your own use, you can use the C compiler link here:
https://www.onlinegdb.com/online_c_compiler#

## quadratic.c
This program calculates the roots of a quadratic function (in the form Ax + Bx + C). 
